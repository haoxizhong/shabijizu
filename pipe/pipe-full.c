...
int gen_need_valC()
{
    return ((if_id_next->icode) == (I_IRMOVL) || (if_id_next->icode) == 
      ...
      (if_id_next->icode) == (I_JMP) || (if_id_next->icode) == (I_CALL) || 
      (if_id_next->icode) == (I_IADDL) || (if_id_next->icode) == (I_TOM));
}
...
int gen_d_srcB()
{
    return (((if_id_curr->icode) == (I_ALU) || (if_id_curr->icode) == 
        ...
        (if_id_curr->icode) == (I_IADDL) || (if_id_curr->icode) == (I_TOM))
...
int gen_d_dstM()
{
    return (((if_id_curr->icode) == (I_MRMOVL) || (if_id_curr->icode) == 
        (I_POPL) || (if_id_curr->icode) == (I_TOM)) ? (if_id_curr->ra) : (
        (if_id_curr->icode) == (I_LEAVE)) ? (REG_EBP) : (REG_NONE));
}
...
int gen_aluB()
{
    return (((id_ex_curr->icode) == (I_RMMOVL) || (id_ex_curr->icode) == 
        ...
        (I_TOM)) ? (id_ex_curr->valb) : ((id_ex_curr->icode) == (I_RRMOVL)
...
int gen_mem_addr()
{
    return (((ex_mem_curr->icode) == (I_RMMOVL) || (ex_mem_curr->icode) == 
        ...
        (I_TOM)) ? (ex_mem_curr->vale) : ((ex_mem_curr->icode) == (I_POPL)
...
int gen_mem_read()
{
    return ((ex_mem_curr->icode) == (I_MRMOVL) || (ex_mem_curr->icode) == 
      (I_POPL) || (ex_mem_curr->icode) == (I_RET) || (ex_mem_curr->icode)
       == (I_LEAVE) || (ex_mem_curr->icode) == (I_TOM));
}
...
int gen_mem_tom()
{
    return ((ex_mem_curr->icode) == (I_TOM));
}
...
int gen_F_stall()
{
    return ((((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
          ...
          (id_ex_curr->icode) == (I_TOM)) & ((id_ex_curr->destm) == 
...
int gen_D_stall()
{
    return (((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
        (I_POPL) || (id_ex_curr->icode) == (I_LEAVE) || (id_ex_curr->icode)
         == (I_TOM)) & ((id_ex_curr->destm) == (id_ex_next->srca) || 
