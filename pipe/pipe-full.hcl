...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL,
	  IOPL, IJXX, ICALL, IRET, IPUSHL, IPOPL , IIADDL , ILEAVE,ITOM};
...
bool need_regids =
	f_icode in { IRRMOVL, IOPL, IPUSHL, IPOPL, 
		     IIRMOVL, IRMMOVL, IMRMOVL , IIADDL , ITOM};

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVL, IRMMOVL, IMRMOVL, IJXX, ICALL , IIADDL , ITOM};
...
int d_srcB = [
	D_icode in { IOPL, IRMMOVL, IMRMOVL, IIADDL , ITOM} : D_rB;
...
int d_dstM = [
	D_icode in { IMRMOVL, IPOPL,ITOM} : D_rA;
	D_icode in { ILEAVE } :REBP;
	1 : RNONE;  # Don't write any register
];
...
int aluA = [
	...
	E_icode in { IIRMOVL, IRMMOVL, IMRMOVL, IIADDL,ITOM } : E_valC;
...
int aluB = [
	E_icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		     IPUSHL, IRET, IPOPL, IIADDL ,ITOM} : E_valB;
...
int mem_addr = [
	M_icode in { IRMMOVL, IPUSHL, ICALL, IMRMOVL ,ITOM} : M_valE;
	M_icode in { IPOPL, IRET, ILEAVE } : M_valA;
	# Other instructions don't need address
];

## Set read control signal
bool mem_read = M_icode in { IMRMOVL, IPOPL, IRET, ILEAVE ,ITOM};

## Set write control signal
bool mem_write = M_icode in { IRMMOVL, IPUSHL, ICALL };

bool mem_tom = M_icode in {ITOM};
...
bool F_stall =
	...
	E_icode in { IMRMOVL, IPOPL, ILEAVE ,ITOM} &&
...
bool D_bubble =
	...
	!(E_icode in { IMRMOVL, IPOPL, ILEAVE ,ITOM} && E_dstM in { d_srcA, d_srcB }) &&
	  IRET in { D_icode, E_icode, M_icode };
